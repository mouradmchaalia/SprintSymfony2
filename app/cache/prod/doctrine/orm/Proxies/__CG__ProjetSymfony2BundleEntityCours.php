 ...
 */
class Cours extends \Projet\Symfony2Bundle\Entity\Cours implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Projet\\Symfony2Bundle\\Entity\\Cours' . "\0" . 'idCours', '' . "\0" . 'Projet\\Symfony2Bundle\\Entity\\Cours' . "\0" . 'theme');
        }
