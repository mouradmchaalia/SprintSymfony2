 ...
 */
class Rdv extends \Projet\Symfony2Bundle\Entity\Rdv implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Projet\\Symfony2Bundle\\Entity\\Rdv' . "\0" . 'idRdv', '' . "\0" . 'Projet\\Symfony2Bundle\\Entity\\Rdv' . "\0" . 'nbreHeure', '' . "\0" . 'Projet\\Symfony2Bundle\\Entity\\Rdv' . "\0" . 'date', '' . "\0" . 'Projet\\Symfony2Bundle\\Entity\\Rdv' . "\0" . 'lieu', '' . "\0" . 'Projet\\Symfony2Bundle\\Entity\\Rdv' . "\0" . 'idCandidat', '' . "\0" . 'Projet\\Symfony2Bundle\\Entity\\Rdv' . "\0" . 'idMoniteur');
        }
    ...
    public function setIdMoniteur(\Projet\Symfony2Bundle\Entity\Moniteur $idMoniteur = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setIdMoniteur', array($idMoniteur));

        return parent::setIdMoniteur($idMoniteur);
    }
